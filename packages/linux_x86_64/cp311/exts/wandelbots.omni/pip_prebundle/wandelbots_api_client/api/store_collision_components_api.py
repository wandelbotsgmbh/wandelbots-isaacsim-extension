...
class StoreCollisionComponentsApi:
    ...
    async def get_default_link_chain(
        self,
        cell: Annotated[StrictStr, Field(description="Unique identifier addressing a cell in all API calls. ")],
        motion_group_model: Annotated[StrictStr, Field(description="Unique identifier for the type of a motion group (robot model).  Get the model name for a configured motion group from [getOptimizerConfiguration](#/operations/getOptimizerConfiguration). ")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
