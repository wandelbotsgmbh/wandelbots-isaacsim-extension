...
class LibraryRecipeApi:
    ...
    async def create_recipe(
        ...
        body: Dict[str, Any],
        name: Annotated[Optional[StrictStr], Field(description="If no initial name is set, a default name based on the program and timestamp is created. ")] = None,
    ...
    async def delete_recipe(
        self,
        cell: Annotated[StrictStr, Field(description="Unique identifier addressing a cell in all API calls. ")],
        recipe: Annotated[StrictStr, Field(description="Recieved from [listRecipeMetadata](#/operations/listRecipeMetadata) or from the response of [createRecipe](#/operations/createRecipe). ")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    async def delete_recipe_list(
        self,
        cell: Annotated[StrictStr, Field(description="Unique identifier addressing a cell in all API calls. ")],
        recipe_ids: Annotated[List[StrictStr], Field(description="Received from [listRecipeMetadata](#/operations/listRecipeMetadata) or from the response of [createRecipe](#/operations/createRecipe)")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
