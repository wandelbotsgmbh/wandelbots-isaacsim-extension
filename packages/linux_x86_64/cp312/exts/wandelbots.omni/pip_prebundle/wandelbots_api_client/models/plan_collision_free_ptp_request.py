...
class PlanCollisionFreePTPRequest(BaseModel):
    ...
    """ # noqa: E501
    robot_setup: OptimizerSetup = Field(description="The robot setup as returned from the [getOptimizerConfiguration](#/operations/getOptimizerConfiguration) endpoint.") 
