...
class PlanCollisionFreeRequest(BaseModel):
    ...
    """ # noqa: E501
    motion_group_setup: MotionGroupSetup = Field(description="The data to assemble the robot setup can be retrieved from the [getMotionGroupDescription](#/operations/getMotionGroupDescription) endpoint.") 
