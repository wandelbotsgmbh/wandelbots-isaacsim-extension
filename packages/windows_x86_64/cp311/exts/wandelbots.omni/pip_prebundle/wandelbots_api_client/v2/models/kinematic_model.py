...
class KinematicModel(BaseModel):
    ...
    kinematic_chain_offset: Optional[Pose] = Field(default=None, description="Constant coordinate transformation between the motion group base frame and the start of the kinematic chain modeled by Denavit-Hartenberg parameters.") 
    inverse_solver: Optional[StrictStr] = Field(default=None, description="Optional name of the inverse kinematics solver.") 
    __properties: ClassVar[List[str]] = ["dh_parameters", "kinematic_chain_offset", "inverse_solver"]
