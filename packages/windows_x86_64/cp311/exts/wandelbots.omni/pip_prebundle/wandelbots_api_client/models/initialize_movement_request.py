...
class InitializeMovementRequest(BaseModel):
    ...
    """ # noqa: E501
    message_type: Optional[StrictStr] = Field(default='InitializeMovementRequest', description="Type specifier for the server, set automatically. ") 
    trajectory: StrictStr = Field(description="The UUID of the trajectory which should be executed and locked to the connection. Get information about the trajectory via [getMotionTrajectorySample](#/operations/getMotionTrajectorySample) or [getMotionTrajectory](#/operations/getMotionTrajectory).") 
