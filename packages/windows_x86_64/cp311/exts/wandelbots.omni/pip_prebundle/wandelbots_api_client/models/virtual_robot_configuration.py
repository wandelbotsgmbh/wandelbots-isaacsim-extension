...
class VirtualRobotConfiguration(BaseModel):
    ...
    content: StrictStr = Field(description="Content of the configuration file. Copy & paste to the [addRobotController](#/operations/addRobotController) configuration.json parameter. ") 
