...
class VirtualController(BaseModel):
    ...
    var_json: Optional[StrictStr] = Field(default=None, description="Complete JSON configuration of the virtual robot controller. Can be obtained from the physical controller's configuration via [getVirtualRobotConfiguration](#/operations/getVirtualRobotConfiguration). If this field is provided, the `type` field should not be used. ", alias="json") 
