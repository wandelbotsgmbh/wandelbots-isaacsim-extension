    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.network_devices:
            for _item in self.network_devices:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "network_devices": [
                ...
                NetworkDevice.from_dict(_item) if hasattr(NetworkDevice, 'from_dict') else _item
                # <<< End modification
                for _item in obj["network_devices"]
            ] if obj.get("network_devices") is not None else None
        })
        return _obj
