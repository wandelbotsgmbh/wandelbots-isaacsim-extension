...
class MotionGroupDescription(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["motion_group_model", "mounting", "tcps", "safety_zones", "safety_link_colliders", "safety_tool_colliders", "operation_limits", "payloads", "cycle_time", "dh_parameters", "kinematic_chain_offset", "serial_number"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "kinematic_chain_offset": Pose.from_dict(obj["kinematic_chain_offset"]) if obj.get("kinematic_chain_offset") is not None else None,
