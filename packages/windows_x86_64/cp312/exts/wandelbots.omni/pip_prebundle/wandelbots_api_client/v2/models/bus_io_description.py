...
class BusIODescription(BaseModel):
    ...
    name: StrictStr = Field(description="Name of the input/output. Customize it using the respective BUS service, e.g., [addProfinetIO](#/operations/addProfinetIO) for PROFINET service. ") 
