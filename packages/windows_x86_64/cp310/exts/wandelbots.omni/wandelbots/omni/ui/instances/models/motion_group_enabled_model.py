...
class MotionGroupEnabledModel(ui.SimpleBoolModel):
    ...
    def _get_prim_value(self) -> bool:
        return self.motion_group_configuration.enabled
    ...
    def _set_prim_value(self, value: bool):
        ...
        if motion_group_config.enabled == value:
            return

        motion_group_config.enabled = value
