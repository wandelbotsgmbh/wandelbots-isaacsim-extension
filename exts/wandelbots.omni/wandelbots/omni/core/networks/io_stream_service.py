...
def _get_requests_headers(access_token: str | None):
    return (
...
class ControllerIOStreamService:
    ...
    async def subscribe(
        self, io_ids: list[str], on_change: OnChangeCallback
    ) -> Subscription:
    ...
    async def start_stream(self):
        async with self._io_stream_lock:
            ...
            try:
                ...
                return
            asyncio.create_task(self.io_stream.start_listening())
...
class IOStreamService:
    ...
    async def subscribe(
        ...
        async with self._controller_services_lock:
            ...
            subscription = await controller_service.subscribe(io_ids, on_change)
    ...
    async def get_io_type(
        ...
        headers = _get_requests_headers(api_configuration.access_token)
